...
class _OnboardingState extends State<OnboardingScreen> {
  ...
  static const _pages = [
    _OBData(
      ...
      subtitle:
          'Explore the finest dining experiences curated for the most discerning palates in your city.',
    ...
    _OBData(
      ...
      title: 'Reserve Your\nPerfect Table',
      subtitle:
          'Book in seconds. Choose your table, date, and time with our seamless reservation system.',
    ...
    _OBData(
      ...
      title: 'Unforgettable\nDining Moments',
      subtitle:
          'Every meal tells a story. Create memories that last a lifetime at the world\'s best restaurants.',
