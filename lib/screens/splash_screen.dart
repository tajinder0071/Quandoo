        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              // ── FIX: never use SizedBox(width: double.infinity) ──
              // inside a Row — it forces infinite constraints.
              // Use Expanded for the full-width case instead.
              if (_page < 2)
              // Pages 0 & 1: Skip (left) + Next button (right, fixed width)
                Row(children: [
                  TextButton(
                    onPressed: _skip,
                    child: Text('Skip',
              ...
              // Page 2: full-width Get Started button — use Row + Expanded,
              // NOT SizedBox(width: double.infinity) which crashes in a Row.
                Row(children: [
                  Expanded(
