    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _OrderTypeBadge(type: widget.orderType, restaurant: widget.restaurant),
...
class _OrderTypeBadge extends StatelessWidget {
  ...
  final dynamic restaurant;
  const _OrderTypeBadge({required this.type, required this.restaurant});
      ...
      child: Row(children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(
              isDelivery
                  ? 'Delivering to 42 Maple Street · ~35 min'
...
class _CartItemRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Row(children: [
      ClipRRect(
        borderRadius: BorderRadius.circular(10),
        child: SizedBox(width: 64, height: 64, child: NetImg(item.imageUrl)),
      ),
      const SizedBox(width: 12),
      Expanded(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
...
class _CouponBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        const Icon(Icons.local_offer_rounded, size: 16, color: AppTheme.gold),
        const SizedBox(width: 8),
        Text('Promo Code',
            style: GoogleFonts.dmSans(
                fontSize: 13,
      ...
      Row(children: [
        Expanded(
          child: TextField(
            ...
            enabled: !applied,
            style: GoogleFonts.dmSans(color: AppTheme.text1, fontSize: 13),
      ...
      if (!applied)
        Padding(
          ...
          child: Text('Try: TABLELUX20 for 20% off',
              style: GoogleFonts.dmSans(
