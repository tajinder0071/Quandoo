            ...
            headerSliverBuilder: (_, __) => [
              SliverAppBar(
                ...
                actions: [
                  GestureDetector(
                    onTap: () =>
                        context.read<AppBloc>().add(ToggleFavorite(r.id)),
                    child: Container(
                      margin: EdgeInsets.all(8),
                      ...
                      Row(
                        children: [
                          ...
                          _InfoBadge(
                            ...
                            '${r.availableTables} tables available',
                          ),
                        ],
                      ),
                    ],
        ...
        child: Column(
          children: [
            ...
            InfoRow(
              ...
              label: 'Available',
              value: '${r.availableTables} tables',
            ),
          ],
        ),
      ),
